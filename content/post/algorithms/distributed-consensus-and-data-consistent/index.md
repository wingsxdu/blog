...
作为区块链领域最重要的两类共识算法，POW 与 POS 都引入了经济学的概念，只要让攻击的成本远远高于收益并且十分高昂，就可以消除攻击者的动机，保证多数人的利益。对于区块链共识感兴趣的同学，可以观看视频 *[Proof-of-Stake (vs proof-of-work)](https://youtu.be/M3EFi_POhps)* 更详细地介绍了 POW 与 POS 的区别和优缺点。
